...
int main()
{
    try
    {
        ...
        Router router(osmPath, "weightsnew2.csv");
        GPXParser parser;
        ...
        const double LEARNING_RATE = 1; // Hyperparameter für kleinere, stabilere Schritte
        ...
        for (int epoch = 1; epoch <= EPOCHS; ++epoch)
        {
            ...
            std::string logPath = std::format("logs/weights2_epoch_{:03d}.csv", epoch);
